...
\begin{table}[htb]
  ...
  \begin{center}
    \begin{tabular}{|c|c|c|c|c|c|} \hline
      ...
      user\verb|_|id & int(5) unsigned & NO & PRIMARY & NULL & \\ \hline
...
\begin{table}[htb]
  ...
  \begin{center}
    \begin{tabular}{|c|c|c|c|c|c|} \hline
      属性 & データ型/長 & NULL & Key & 初期値 & その他 \\ \hline \hline
      driver\verb|_|id & int(5) unsigned & NO & PRIMARY & NULL & \\ \hline
      name & varchar(64) & NO &   & NULL & \\ \hline
      mail & varchar(64) & NO &   & NULL & \\ \hline
...
\begin{table}[htb]
  ...
  \begin{center}
    \begin{tabular}{|c|c|c|c|c|c|} \hline
      属性 & データ型/長 & NULL & Key & 初期値 & その他 \\ \hline \hline
      user\verb|_|id & int(5) unsigned & NO & FOREIGN & NULL & \\ \hline
